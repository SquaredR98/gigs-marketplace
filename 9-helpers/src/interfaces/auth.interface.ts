/**
 * Helps avoid TS related error as Express Request type does not
 * have currentUser to it. So, we have to add it manually to it.
 *
 * Typescript declaration merging technique to extend the existing
 * types of the Express framework.
 */
declare global {
  namespace Express {
    interface Request {
